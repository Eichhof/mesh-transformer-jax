...
sudo pip install --upgrade jaxlib==0.1.68 jax==0.2.16 ray[default]==1.5.1 fabric dataclasses optax git+https://github.com/deepmind/dm-haiku tqdm cloudpickle smart_open[gcs] einops func_timeout